...
local function jump_to_end_of_word_keymaps()
	keymap.set({ "i" }, "<A-Right>", "<C-o>w", { noremap = true, silent = true, desc = "Jump to end of word" })
	keymap.set({ "i" }, "<A-Left>", "<C-o>b", { noremap = true, silent = true, desc = "Jump to begining of word" })
end
...
local function return_to_normal_mode()
	keymap.set("i", "jj", "<ESC>", { noremap = true, silent = true, desc = "Return to normal mode" })
end
local function deselect_visual_mode()
	keymap.set("n", "<ESC>", "<cmd>nohlsearch<cr>", { noremap = true, silent = true, desc = "Deselect visual mode" })
end
local function tmux_navigation()
	keymap.set("n", "C-h", ":TmuxNavigateLeft<CR>", { noremap = true, silent = true, desc = "Navigate left" })
	keymap.set("n", "C-j", ":TmuxNavigateDown<CR>", { noremap = true, silent = true, desc = "Navigate down" })
	keymap.set("n", "C-k", ":TmuxNavigateUp<CR>", { noremap = true, silent = true, desc = "Navigate up" })
	keymap.set("n", "C-l", ":TmuxNavigateRight<CR>", { noremap = true, silent = true, desc = "Navigate right" })
	keymap.set("n", "C-\\", ":TmuxNavigatePrevious<CR>", { noremap = true, silent = true, desc = "Navigate previous" })
end
return {
