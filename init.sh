...
#             if has_accept_flag; then
#                 yes | /home/linuxbrew/.linuxbrew/bin/brew install "$package"
#             else
...
#             fi
#             # if /bin/zsh does not exist, create a symlink to /home/linuxbrew/.linuxbrew/bin/zsh
#             if [ ! -f "/bin/zsh" ]; then
#                 sudo ln -s "$zsh_path" /bin/zsh
#             fi
#         fi
#         print_line "Changing shell to zsh $zsh_path..."
